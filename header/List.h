 ...
 * @param deleteVal if the "VAL" value of the node should be freed.*/
void 	delList	(List*, int deleteVal);
 ...
 * @param out (out) the removed element
 * @return ERRINDEX if position is out of list bounds
 * @return OK otherwise
 */
status 	remFromListAt	(List*,int,void** out);
...
/** remove given element from given list, returning the removed element as param .
 * implies the user has given a comparison function.
 * @param l the list to remove the element from
 * @param e the element to remove
 * @param out (out) the removed element
 ...
 * @return OK otherwise
 */
status 	remFromListGetElement(List*,void* e, void** out);
 ...
 * @return ERRUNABLE if no print function has been provided
 * @return OK otherwise
*/
